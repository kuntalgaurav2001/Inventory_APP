      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          <View style={styles.welcomeSection}>
            ...
            <Text style={styles.title}>Account Team Dashboard</Text>
          </View>
      ...
      <ScrollView style={styles.scrollContainer}>
        <View style={styles.userInfoCard}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoValue}>ACCOUNT TEAM</Text>
          </View>
          <View style={styles.infoRow}>
        ...
        <View style={styles.quickAccessCard}>
          ...
          <TouchableOpacity 
            style={[styles.quickAccessButton, styles.financialButton]}
            onPress={() => navigation.navigate('FinancialData')}
          >
            <FontAwesome5 name="chart-line" size={24} color="#fff" />
            <Text style={styles.quickAccessText}>Financial Data</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.quickAccessText}>Purchase Orders</Text>
          </TouchableOpacity>
          
          <TouchableOpacity 
            style={[styles.quickAccessButton, styles.secondaryButton]}
            onPress={() => navigation.navigate('AccountReports')}
          >
            <FontAwesome5 name="file-invoice-dollar" size={24} color="#fff" />
            <Text style={styles.quickAccessText}>Account Reports</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.permissionsCard}>
          <View style={styles.permissionsHeader}>
            ...
            <Text style={styles.permissionsTitle}>Your Account Team Permissions</Text>
          </View>
          <View style={styles.permissionList}>
            ...
            <View style={styles.permissionItem}>
              <Ionicons name="checkmark-circle" size={16} color="#28a745" />
              <Text style={styles.permissionText}>Process purchase orders</Text>
            </View>
            <View style={styles.permissionItem}>
              <Ionicons name="checkmark-circle" size={16} color="#28a745" />
              <Text style={styles.permissionText}>View account reports</Text>
            </View>
            <View style={styles.permissionItem}>
              <Ionicons name="checkmark-circle" size={16} color="#28a745" />
              <Text style={styles.permissionText}>Track expenses and budgets</Text>
            </View>
          </View>
        </View>
      </ScrollView>
